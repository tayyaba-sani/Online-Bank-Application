...
class CardsControllerTest {
    ...
    void happyPathToIssueCard() throws Exception {
        when(iApplyCardService.issueCard(any(CardDetails.class))).thenReturn(expectedCardDetails);
    ...
    void happyPathToActivate() throws Exception{
        ...
        when(iActivateDeactivateCardService.activate(any(CardRequest.class))).thenReturn(expectedCardDetails);
    ...
    void happyPathToDeactivate() throws Exception {
        ...
        when(iActivateDeactivateCardService.deactivate(any(CardRequest.class))).thenReturn(expectedCardDetails);
    ...
    void happyPathToFetchAllCardDetails() throws Exception {
        ...
        when(iCardDetailService.fetchAllCardDetails(accountNumber)).thenReturn(cardDetailsList);
    ...
    void happyPathToFetchCardDetailsByCardNumber() throws Exception {
        ...
        when(iCardDetailService.fetchCardDetailsByCardNumber(cardNumber)).thenReturn(expectedCardDetails);
    ...
    void happyPathToExtendExpiredDate() throws Exception{
        ...
        when(iExtendCardService.extendExpiredDate(any(CardRequest.class))).thenReturn(expectedCardDetails);
