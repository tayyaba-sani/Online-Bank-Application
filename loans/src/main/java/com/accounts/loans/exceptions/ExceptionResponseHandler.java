...
import com.accounts.loans.dtos.ExceptionObj;
...
public class ExceptionResponseHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionObj> handleAccountNotFoundExceptions(LoanDetailsNotFoundException ex, WebRequest request) {
