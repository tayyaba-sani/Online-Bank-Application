...
class LoansControllerTest {
    ...
    void happyPathToApplyForLoan() throws Exception{
        when(iApplyLoanService.applyForLoan(any(LoanDetails.class))).thenReturn(expectedLoanDetails);
    ...
    void happyPathToPaidLoanAmount() throws Exception {
        ...
        when(iPaidLoanService.paidLoanAmount(any(LoanDetails.class))).thenReturn(expectedLoanDetails);
    ...
    void happyPathToGetLoansDetails() throws Exception {
        ...
        when(iLoanDetailService.getLoanDetails(1598472658)).thenReturn(loanDetailsList);
    ...
    void happyPathToDeleteLoan() throws Exception {
        ...
        when(iDeleteLoanService.deleteLoan(any(DeleteLoanRequest.class))).thenReturn(true);
